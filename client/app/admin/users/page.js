            ...
            <div className="flex gap-3 items-center">
              <div className="relative w-full md:w-64">
                ...
                <Input
                  ...
                  className="pl-10 h-10 bg-white border-gray-200 focus:border-emerald-500 focus:ring-emerald-500"
                />
              </div>
              ...
              >
                <DrawerTrigger asChild>
                  <Button
                    variant="outline"
                    size="default"
                    className="h-10 px-4 bg-white border-gray-200 hover:bg-gray-50 text-gray-700 transition-colors relative"
                  >
